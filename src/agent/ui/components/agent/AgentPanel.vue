    ...
    >
      ...
      <template v-else>
        ...
        <div class="ccsim-panel__body">
          ...
          <VisitorInfoPanel v-if="store.currentSessionId" />
        </div>
      </template>
    </div>
  </Transition>
...
import VisitorInfoPanel from './VisitorInfoPanel.vue'
import { useDrag } from '@/agent/ui/composables/useDrag'
import { useFullscreen } from '@/agent/ui/composables/useFullscreen'
import { useAgentLogin } from '@/agent/ui/composables/useAgentLogin'
import { t as $t } from '@/core/i18n'
