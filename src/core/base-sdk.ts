...
import { EventBus } from '@/core/store/events'
import { WsClient, type UrlProvider } from '@/core/connection/WsClient'
import { logger } from '@/core/utils/logger'
import { LogLevel } from '@/core/types'
import { CcsimError, toCcsimError } from '@/core/utils/errors'
import { logVersion } from '@/core/utils/version'
import { clearAllTimers } from '@/core/messaging/send'
import { t } from '@/core/i18n'
import { AUTH_TIMEOUT } from '@/core/utils/constants'
...
export abstract class BaseSDK {
  ...
  protected connect() {
    ...
    this.ws.onError((error) => {
      logger.error(`[${this.logTag}] WebSocket 错误:`, error)
